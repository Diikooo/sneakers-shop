              ...
              <li className="nav-item">
                ...
                >
                  <p className=" m-0 d-flex align-center">
                    <i
                      className="fa-solid fa-cart-plus fs-3 position-relative"
                      data-bs-toggle="tooltip"
                      data-bs-placement="bottom"
                      data-bs-title="Selected sneakers"
                    >
              ...
              <li className="nav-item">
                <button className="btn py-2 me-2">
                  <Link to="/orders">
                    {" "}
                    <i
                      className="fa-solid fa-clipboard-check fs-3"
                      data-bs-toggle="tooltip"
                      data-bs-placement="bottom"
    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <li className="nav-item">
              ...
              <li className="nav-item">
                <button className="btn py-2 me-2">
                  <Link to="/user">
                    <img src="ds" className="fs-3" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Profile"/>
                  </Link>
                </button>
              </li>
      </ul>
